...
package com.bourre.load
{
		...
		implements ILoad
	{
		...
		public function AbstractLoad()
		{
			var s : String = getQualifiedClassName( this );
			if ( s == "com.bourre.loading::AbstractLoad" )
		...
		public function addListener( listener : ILoadListener ) : void
		{
			_oEB.addListener( listener );
		}

		public function removeListener( listener : ILoadListener ) : void
		{
