package com.bourre.commands 
{
	 ...
	 * the implementer should create a <code>Suspendable</code> object instead
	 * of a cancelable one.
	 * <p>
	 * More formally, an operation is cancelable if the operation couldn't be
	 * paused(stopped) and resumed(re-started) without breaking the state of the
	 * process, or if there is a need for the operation to abort during its process.
	 * For example, a loading process could be stopped by an action of the user.  
	 * </p><p>
