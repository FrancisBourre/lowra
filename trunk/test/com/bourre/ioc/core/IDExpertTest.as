package com.bourre.ioc.core
{
		...
		extends TestCase
	{
		...
		public function testBasicRefSorting() : void
		{
			...
			_oIE.onBuildProperty( new PropertyEvent( PropertyEvent.onBuildPropertyEVENT, null, p0 ) );
			_oIE.onBuildProperty( new PropertyEvent( PropertyEvent.onBuildPropertyEVENT, null, p1 ) );
		...
		public function testRefSorting() : void
		{
			...
			_oIE.onBuildProperty( new PropertyEvent( PropertyEvent.onBuildPropertyEVENT, null, p2 ) );
			_oIE.onBuildProperty( new PropertyEvent( PropertyEvent.onBuildPropertyEVENT, null, p3 ) );
